...
describe('addMinutesToTime()', () => {
    ...
    test('negative additional minutes cases', () => {
    ...
    test('negative time object cases', () => {
        expect(() =>
    ...
    describe('Given the current time is 1 hour 30 minutes', () => {
        ...
        test('When adding an additional 30 minutes', () => {
    ...
    describe('Given the current time is 23 hour 30 minutes', () => {
        ...
        test('When adding an additional 1500 minutes', () => {
